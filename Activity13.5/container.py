import os
import sys
import pymysql  # why all of a sudden he's using a different library for mysql? It used to be mysql-connector-python
...
def init_mysql():
    ...
    cnx = pymysql.connect(user="root", password="MyNewPass", host="127.0.0.1", port=3307)
...
if argument == "-create":
    ...
    create(
        "docker run -p 6379:6379 --name some-redis -d redis", "redis"
